...
RSpec.describe Chat::Mobivolt::LeadScoreCalculator, type: :service do
  ...
  describe '.calculate' do
    it 'calcula o score com base em um lead simples (frio)' do
    ...
    it 'calcula o score incremental com vários atributos (quente)' do
      chat_lead = ChatLead.new(
        chat_session: chat_session,
        name: 'Cliente Quente',
      ...
      # 7. E-mail: +5
      # 8. Urgência: +10
      # Total: 15+20+10+15+20+20+5+10 = 115 -> clamped to 100
      
      score = described_class.calculate(chat_lead)
      expect(score).to eq(100)
    end

    it 'aplica pontuação parcial corretamente' do
      chat_lead = ChatLead.new(
        chat_session: chat_session,
