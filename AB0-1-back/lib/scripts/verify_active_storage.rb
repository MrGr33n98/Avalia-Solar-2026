...
# Usage:
#   rails runner "Scripts::VerifyActiveStorage.run"
#
# Note: this file must define Scripts::VerifyActiveStorage for Zeitwerk.

module Scripts
  class VerifyActiveStorage
    def self.run
