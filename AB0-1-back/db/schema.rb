...
ActiveRecord::Schema[7.0].define(version: 2026_09_19_000000) do
  ...
  create_table "banner_addon_subscriptions", force: :cascade do |t|
    t.bigint "company_id", null: false
    t.bigint "banner_id"
    t.bigint "banner_addon_id", null: false
    ...
    t.text "checkout_url"
    t.index ["banner_addon_id"], name: "index_banner_addon_subscriptions_on_banner_addon_id"
    t.index ["banner_id"], name: "index_banner_addon_subscriptions_on_banner_id"
    t.index ["checkout_session_id"], name: "index_banner_addon_subscriptions_on_checkout_session_id"
    t.index ["company_id", "idempotency_key"], name: "idx_banner_addon_subscriptions_idempotency", unique: true, where: "(idempotency_key IS NOT NULL)"
    t.index ["company_id"], name: "index_banner_addon_subscriptions_on_company_id"
    t.index ["ends_at"], name: "index_banner_addon_subscriptions_on_ends_at"
    t.index ["payment_reference"], name: "index_banner_addon_subscriptions_on_payment_reference"
    t.index ["status"], name: "index_banner_addon_subscriptions_on_status"
    t.check_constraint "ends_at > starts_at", name: "ck_banner_addon_subs_valid_dates"
  end

  create_table "banner_addons", force: :cascade do |t|
    t.string "name", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["category"], name: "index_banner_addons_on_category"
    t.index ["code"], name: "index_banner_addons_on_code", unique: true
    t.index ["is_active"], name: "index_banner_addons_on_is_active"
  end

  create_table "banner_audit_logs", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["action"], name: "index_banner_audit_logs_on_action"
    t.index ["actor_type", "actor_id"], name: "index_banner_audit_logs_on_actor"
    t.index ["auditable_type", "auditable_id"], name: "index_banner_audit_logs_on_auditable"
    t.index ["source"], name: "index_banner_audit_logs_on_source"
  end
  ...
  create_table "companies", force: :cascade do |t|
    ...
    t.index ["state", "city", "rating_avg"], name: "idx_companies_geo_rating"
  ...
  create_table "company_products", force: :cascade do |t|
    t.bigint "company_id", null: false
    t.bigint "product_id", null: false
    t.string "relationship_type", default: "catalog_owner", null: false
    t.string "status", default: "active", null: false
    t.boolean "authorized", default: false, null: false
    t.jsonb "territories", default: [], null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["company_id", "product_id"], name: "index_company_products_on_company_id_and_product_id", unique: true
  ...
  create_table "company_services", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["category_id"], name: "index_company_services_on_category_id"
    t.index ["company_id", "category_id", "status"], name: "idx_company_services_context"
    t.index ["company_id", "slug"], name: "index_company_services_on_company_id_and_slug", unique: true
  ...
  create_table "mcp_agent_credentials", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["agent_identity_id", "status"], name: "index_mcp_agent_credentials_on_agent_identity_id_and_status"
    t.index ["agent_identity_id"], name: "index_mcp_agent_credentials_on_agent_identity_id"
    t.index ["key_id"], name: "index_mcp_agent_credentials_on_key_id", unique: true
    t.check_constraint "status::text = ANY (ARRAY['active'::character varying, 'revoked'::character varying, 'expired'::character varying]::text[])", name: "chk_mcp_agent_credentials_status"
  end

  create_table "mcp_approval_requests", force: :cascade do |t|
    t.string "request_uuid", null: false
    t.string "agent_id", null: false
    t.bigint "tenant_id"
    t.string "tool_name", null: false
    t.jsonb "parameters_payload", default: {}, null: false
    ...
    t.index ["agent_id"], name: "index_mcp_approval_requests_on_agent_id"
    t.index ["approved_by_user_id"], name: "index_mcp_approval_requests_on_approved_by_user_id"
    t.index ["execution_id"], name: "index_mcp_approval_requests_on_execution_id"
    t.index ["expires_at"], name: "index_mcp_approval_requests_on_expires_at"
    t.index ["payload_digest"], name: "index_mcp_approval_requests_on_payload_digest"
    t.index ["request_uuid"], name: "index_mcp_approval_requests_on_request_uuid", unique: true
    t.index ["requested_by_user_id"], name: "index_mcp_approval_requests_on_requested_by_user_id"
    t.index ["risk_tier", "status"], name: "index_mcp_approval_requests_on_risk_tier_and_status"
    t.index ["snoozed_until"], name: "index_mcp_approval_requests_on_snoozed_until"
    t.index ["status", "expires_at"], name: "index_mcp_approval_requests_on_status_and_expires_at"
    t.index ["status"], name: "index_mcp_approval_requests_on_status"
    t.index ["tenant_id"], name: "index_mcp_approval_requests_on_tenant_id"
    t.check_constraint "risk_tier::text = ANY (ARRAY['r0'::character varying, 'r1'::character varying, 'r2'::character varying, 'r3'::character varying, 'r4'::character varying]::text[])", name: "chk_mcp_approval_requests_risk_tier"
    t.check_constraint "status::text = ANY (ARRAY['pending'::character varying, 'approved'::character varying, 'rejected'::character varying, 'executed'::character varying, 'expired'::character varying]::text[])", name: "chk_mcp_approval_requests_status"
  end
  ...
  create_table "payment_webhook_events", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["provider", "provider_event_id"], name: "index_payment_webhook_events_on_provider_and_provider_event_id", unique: true
  ...
  create_table "product_offers", force: :cascade do |t|
    t.bigint "company_product_id", null: false
    t.decimal "price", precision: 12, scale: 2
    t.integer "stock"
    t.integer "lead_time_days"
    t.boolean "installation_available", default: false, null: false
    t.jsonb "coverage", default: [], null: false
    t.text "commercial_terms"
    t.string "status", default: "active", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["company_product_id", "status"], name: "index_product_offers_on_company_product_id_and_status"
    t.index ["company_product_id"], name: "index_product_offers_on_company_product_id"
  end
  ...
  create_table "review_form_events", force: :cascade do |t|
    t.bigint "company_id", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["company_id"], name: "index_review_form_events_on_company_id"
    t.index ["review_form_id", "event_type", "created_at"], name: "idx_review_form_events_type_time"
    t.index ["review_form_id"], name: "index_review_form_events_on_review_form_id"
  end
  ...
  create_table "review_forms", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["company_id", "slug"], name: "index_review_forms_on_company_id_and_slug", unique: true
    t.index ["company_id", "status"], name: "index_review_forms_on_company_id_and_status"
    t.index ["company_id"], name: "index_review_forms_on_company_id"
  ...
  create_table "reviews", force: :cascade do |t|
    ...
    t.jsonb "form_answers", default: {}, null: false
    ...
    t.index ["company_id", "sentiment"], name: "idx_reviews_analytics_sentiment"
    t.index ["company_id", "status", "created_at"], name: "idx_reviews_analytics_base"
  ...
  create_table "sales_accounts", force: :cascade do |t|
    ...
    t.string "status", default: "prospecting", null: false
    t.jsonb "metadata", default: {}, null: false
  ...
  create_table "sales_activities", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["actor_id"], name: "index_sales_activities_on_actor_id"
    t.index ["sales_account_id"], name: "index_sales_activities_on_sales_account_id"
    t.index ["sales_contact_id"], name: "index_sales_activities_on_sales_contact_id"
  ...
  create_table "sales_founder_inbox_items", force: :cascade do |t|
    t.bigint "company_id", null: false
    t.bigint "sales_account_id"
    t.bigint "sales_opportunity_id"
    ...
    t.string "risk_tier", default: "r0", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["agent_id"], name: "index_sales_founder_inbox_items_on_agent_id"
    t.index ["company_id", "dedupe_key"], name: "idx_sales_founder_inbox_items_dedupe", unique: true
    t.index ["company_id", "status", "observed_at"], name: "idx_sales_founder_inbox_items_queue"
    t.index ["company_id"], name: "index_sales_founder_inbox_items_on_company_id"
    t.index ["mcp_approval_request_id"], name: "index_sales_founder_inbox_items_on_mcp_approval_request_id"
    t.index ["sales_account_id"], name: "index_sales_founder_inbox_items_on_sales_account_id"
    t.index ["sales_opportunity_id"], name: "index_sales_founder_inbox_items_on_sales_opportunity_id"
  end
  ...
  create_table "sales_opportunities", force: :cascade do |t|
    ...
    t.boolean "probability_overridden", default: false, null: false
  ...
  create_table "sales_qualifications", force: :cascade do |t|
    ...
    t.text "need"
    t.text "timeline"
    t.integer "spin_completion", default: 0, null: false
    t.integer "bant_completion", default: 0, null: false
    t.jsonb "metadata", default: {}, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "sales_research_records", force: :cascade do |t|
    t.bigint "company_id", null: false
    t.bigint "sales_account_id"
    t.bigint "sales_contact_id"
    t.bigint "sales_opportunity_id"
    ...
    t.bigint "created_by_id"
    t.string "kind", null: false
    t.string "certainty", default: "unverified", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["agent_id"], name: "index_sales_research_records_on_agent_id"
    t.index ["company_id", "idempotency_key"], name: "idx_sales_research_records_idempotency", unique: true, where: "(idempotency_key IS NOT NULL)"
    t.index ["company_id", "kind", "collected_at"], name: "idx_sales_research_kind_time"
    t.index ["company_id"], name: "index_sales_research_records_on_company_id"
    t.index ["sales_account_id"], name: "index_sales_research_records_on_sales_account_id"
    t.index ["sales_contact_id"], name: "index_sales_research_records_on_sales_contact_id"
    t.index ["sales_opportunity_id"], name: "index_sales_research_records_on_sales_opportunity_id"
  end
  ...
  create_table "sales_stage_histories", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["actor_id"], name: "index_sales_stage_histories_on_actor_id"
  ...
  create_table "sales_stages", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["sales_pipeline_id", "key"], name: "index_sales_stages_on_sales_pipeline_id_and_key", unique: true
  ...
  create_table "sales_tasks", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "idempotency_key"
    t.index ["owner_id"], name: "index_sales_tasks_on_owner_id"
    t.index ["sales_account_id", "idempotency_key"], name: "idx_sales_tasks_idempotency", unique: true, where: "(idempotency_key IS NOT NULL)"
  ...
  add_foreign_key "banner_addon_subscriptions", "banner_addons"
  add_foreign_key "banner_addon_subscriptions", "banners"
  add_foreign_key "banner_addon_subscriptions", "companies"
  ...
  add_foreign_key "group_posts", "group_topics"
  ...
  add_foreign_key "product_offers", "company_products"
  ...
  add_foreign_key "sales_accounts", "companies"
  add_foreign_key "sales_accounts", "users", column: "owner_id"
  add_foreign_key "sales_activities", "sales_accounts"
  ...
  add_foreign_key "sales_founder_inbox_items", "sales_accounts"
  add_foreign_key "sales_founder_inbox_items", "sales_opportunities"
  ...
  add_foreign_key "sales_research_records", "sales_accounts"
  add_foreign_key "sales_research_records", "sales_contacts"
  add_foreign_key "sales_research_records", "sales_opportunities"
