class HardenReviewerPublications < ActiveRecord::Migration[7.0]
  def change
    ...
    add_index :reviewer_publications, %i[user_id published_at], where: "status = 'published'", name: 'idx_reviewer_publications_user_published' unless index_exists?(:reviewer_publications, name: 'idx_reviewer_publications_user_published')
  end
end
