...
class CreateEventPlatformDerivedTables < ActiveRecord::Migration[7.0]
  def up
    ...
    now_func = is_pg ? 'NOW()' : 'CURRENT_TIMESTAMP'
    ...
    create_table :event_definitions, id: false, if_not_exists: true do |t|
      ...
      t.text :description
      t.datetime :created_at, default: -> { now_func }, null: false
      t.datetime :updated_at, default: -> { now_func }, null: false
    end
    ...
    create_table :event_ingest_errors, if_not_exists: true do |t|
      ...
      t.text :error_reason
      t.datetime :occurred_at, default: -> { now_func }, null: false
      t.datetime :created_at, default: -> { now_func }, null: false
      t.datetime :updated_at, default: -> { now_func }, null: false
    end
    ...
    create_table :company_feature_rolling_30d, id: false, if_not_exists: true do |t|
      ...
      t.datetime :computed_at, default: -> { now_func }, null: false
