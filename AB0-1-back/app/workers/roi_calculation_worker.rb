class RoiCalculationWorker
  ...
  def perform(lead_id)
    ...
    # 2. Stub Solar Radiation
    solar_radiation = 4.5 # kWh/m2/day (placeholder)
    ...
    total_investment = lead.respond_to?(:estimated_budget) ? lead.estimated_budget.to_f : 15000.0
    total_investment = 15000.0 if total_investment <= 0
