...
- **Arquivos encontrados:** .codeclimate.yml, .dockerignore, .env, .gitattributes, .gitignore, .markdownlint.json, .ruby-version, ACTIONABLE_BACKLOG.json, auth_diagnostico.md, config.ru, docker-compose.test.yml, docker-compose.yml, Dockerfile, Dockerfile.backend, Dockerfile.frontend, example_categories.csv, executar_seed_mobilidade.bat, Gemfile, Gemfile.lock, gerar-diagnostico.ps1, GITHUB_ACTIONS_AUDIT_REPORT.md, GITHUB_SECRETS_GUIDE.md, GUIA_SEED_MOBILIDADE.md, history.txt, INSTRUCOES_URGENTES.txt, LICENSE, limpar-projeto.bat, package-lock.json, package.json, promt.md, Rakefile, README.md, seed_articles.json, utm-diagnostico-e-plano-v1.md, utm-implementacao-v2-plano-e-patch.md, yarn.lock

### Frontend (AB0-1-front)
- **Status:** [OK] Pasta encontrada
- **Arquivos JavaScript/TypeScript:** 534 arquivos (65802 linhas)
...
- **Arquivos Ruby:** 3502 arquivos (94162 linhas)
...
|--- .trae
|   +--- documents
|       |--- Adicionar botão _Fale WhatsApp_ ao lado de _Solicitar Orçamento_.md
|       |--- Aplicar Correções e Integração Completa.md
|       |--- Aplicar Integração Completa e Corrigir ForbiddenAttributesError.md
|       |--- Aprimorar Botão do WhatsApp com Configuração no Active Admin.md
|       |--- Auto‑login e Privilégios para bsol@test.com no Dashboard.md
|       |--- Botão WhatsApp Condicional via Active Admin.md
|       |--- CI_CD com GitHub MCP para Deploy na DigitalOcean.md
|       |--- Contratação de Banners Patrocinados (Admin + Público).md
|       |--- Correção de Banner Consistente no Home e Detalhe de Empresa.md
|       |--- Corrigir 500 no GET _api_v1_companies__id.md
|       |--- Corrigir ActiveAdmin e Validar User Stories.md
|       |--- Corrigir Contratação de Banners (Admin).md
|       |--- Corrigir definitivamente erro de conexão Redis no update de empresas (Active Admin).md
|       |--- Corrigir erro 500 no Admin Login (ActiveAdmin).md
|       |--- Corrigir Exibição de Banner em Paineis Solares.md
|       |--- Corrigir Exibição de Banners na Categoria Paineis Solares.md
|       |--- Corrigir rede e configuração Docker na VM (AB0-1).md
|       |--- Create Technical Documentation for Dashboard Architecture.md
|       |--- Fluxo de Aprovação e Edição de Empresas.md
|       |--- Gerar e Instalar .env na VM (Produção).md
|       |--- Implementar Contratação de Banners Patrocinados.md
|       |--- Implementação Completa MCP7.md
|       |--- Implementação MCP com shadcn-ui e context7.md
|       |--- Integração Completa Frontend_Backend e Correção de ForbiddenAttributesError.md
|       |--- Modal de Confirmação de Envio de Leads.md
|       |--- Padronizar Botão WhatsApp no CompanyCard.md
|       |--- Padronizar logos_banners em páginas de categorias e eliminar avisos de hidratação.md
|       |--- Padronizar Renderização de Banners entre CategoryCard e CompanyCard.md
|       |--- Plano de Adaptação de Componentes do Dashboard.md
|       |--- Plano de Integração e Adaptação do Dashboard.md
|       |--- plan_20251125_025724.md
|       |--- Refactor Category Page UI_UX.md
|       |--- Refactor Enterprise Dashboard with Shadcn-UI.md
|       |--- Refatorar Dashboard Empresarial (Sidebar + Visão Geral) para Layout de Referência.md
|       |--- Reiniciar Servidor Backend para Corrigir NetworkError.md
|       |--- Resolver Erro de Conexão Redis em Admin__Companies#update.md
|       |--- Resolver erro Ransack em PendingChange.md
|       |--- Resolver Falha de Conexão Redis em Admin__Companies#update.md
|       |--- Resolver Integração Admin + Dashboard e Uploads (Logo_Banner).md
|       |--- Tornar o Dashboard_ActiveAdmin totalmente operacional.md
|       |--- Valid{_title___Validar visibilidade do botão WhatsApp e executar testes_,.md
|       |--- Workflow de Deploy via Docker_Nginx na VPS.md
|       |--- {_title___Corrigir botão WhatsApp, 403 no dashboard e aviso de hidratação_,.md
|       |--- {_title___Corrigir visibilidade dos botões de Orçamento e WhatsApp_,.md
|       |--- {_title___Integração WhatsApp Business API (Envio_Recebimento, Status, Logs)_,.md
|       +--- 修复 ActiveAdmin 审批表单的 CSRF 错误.md
|--- AB0-1-back
|   |--- .github
|   |   +--- workflows
...
|   |       +--- brevo_delivery.rb
|   +--- Dockerfile
|--- backup_limpeza_20260129_121536
|   |--- .env.backup.20260127_120009
|   |--- .env.backup.20262201_110340
|   |--- act.tar.gz
...
|   |   +--- index.js
|   +--- wrangler.toml
|--- code-base-dashboards
|   |--- code-base-dashboard-v3.md
|   |--- dashboard-sumario-v3.md
|   +--- pdr.md
|--- docs
|   |--- analise-fev
|   |   |--- ANALYTICS_REPORT.md
|   |   |--- concat-migrations.js
|   |   |--- concat_migrations.bat
|   |   |--- EXECUTIVE_ROADMAP.md
|   |   |--- EXECUTIVE_SUMMARY.md
|   |   |--- migration-v1.md
|   |   |--- PRODUCTS_STRATEGY_REPORT.md
|   |   |--- SEO_GROWTH_REPORT.md
|   |   |--- TECHNICAL_REPORT.md
|   |   +--- WEBHOOKS_PLATFORM_REPORT.md
|   |--- dashboard
|   |   |--- ANALYTICS_IMPLEMENTATION_PROGRESS.md
|   |   |--- audit-ga4-report.md
|   |   |--- backlog-estrategico.md
|   |   |--- CORE_JOURNEYS_DISCOVERY_MAP.md
|   |   +--- DASHBOARD_IMPROVEMENTS.md
|   |--- docs-auth
|   |   |--- ACESSOS_SUMARIO.md
|   |   +--- login-analise.md
|   |--- docs-banners
|   |   |--- diagnostico-ads-api-guide.md
|   |   |--- diagnostico-ads-diagramas.md
|   |   |--- diagnostico-ads-resumo-executivo.md
|   |   |--- diagnostico-ads-roadmap.md
|   |   +--- diagnostico-ads.md
|   |--- examples
|   |   |--- docker-compose-healthcheck.yml
|   |   |--- health-check-examples.sh
|   |   +--- kubernetes-health-probes.yml
|   |--- geral-docs
|   |   |--- API_ANALYTICS.md
|   |   |--- AUTHENTICATION_ANALYSIS.md
|   |   |--- BANNER_USAGE.md
|   |   |--- CATEGORYCARD_UI_REDESIGN.md
|   |   |--- CHANGELOG.md
|   |   |--- DASHBOARD_REQUIREMENTS.md
|   |   |--- DEPLOY_GUIDE_MCP7.md
|   |   |--- DIAGNOSTICO_COMPLETO_BUILD.md
|   |   |--- financing-confirmation-flow.md
|   |   |--- FIX_CI_BUILD_VARS_PROPAGATION.md
|   |   |--- GTM_CODE_EXAMPLES.md
|   |   |--- GTM_CONSOLE_SETUP_GUIDE.md
|   |   |--- GTM_DEPLOYMENT_PLAN.md
|   |   |--- GTM_DIAGNOSTIC.md
|   |   |--- GTM_EXECUTIVE_SUMMARY.md
|   |   |--- GTM_IMPLEMENTATION_COMPLETE.md
|   |   |--- GTM_IMPLEMENTATION_GUIDE.md
...
|   |   |--- REQUIREMENTS_COMPLIANCE_MCP7.md
|   |   +--- TECHNICAL_REQUIREMENTS_MCP7.md
|   |--- infra
|   |   |--- backup.env.example
|   |   |--- backups.md
|   |   +--- postgres_backup.sh
...
|   |--- docs-auth-ai-agent
|   |   |--- ai-agent-task-generator.json
|   |   |--- AI_AGENT_README.md
|   |   |--- AI_AGENT_USAGE_GUIDE.md
|   |   |--- CORRECOES_IMEDIATAS_AUTH.md
|   |   |--- EXEMPLO_BACKLOG_GERADO.md
|   |   |--- GUIA_DIAGNOSTICO_LOGIN_401.md
|   |   |--- INDEX_DOCUMENTACAO.md
|   |   |--- PROMPT_COPY_PASTE.md
|   |   |--- README_AUDITORIA.md
|   |   +--- RELATORIO_AUDITORIA_CONFIGURACOES.md
|   |--- docs-secrets
|   |   |--- GITHUB_SECRETS_CONFIG.txt
|   |   |--- GITHUB_SECRETS_CONFIGURADOS.md
|   |   +--- GITHUB_SECRETS_SETUP.md
|   |--- docs-v2
|   |   |--- 00-MASTER-INDEX.md
|   |   |--- 07-infra-and-deploy.md
|   |   |--- 08-ci-cd.md
|   |   |--- 09-backend-services.md
|   |   |--- 10-backend-jobs-and-queues.md
|   |   |--- 11-backend-permissions-and-authorization.md
|   |   |--- 12-security-and-auth.md
|   |   |--- 13-performance-and-scalability.md
|   |   |--- 14-testing-strategy.md
|   |   |--- 15-frontend-gaps-and-ux.md
|   |   |--- 16-product-and-business-rules.md
|   |   |--- 17-observability-and-ops.md
|   |   |--- 19-refactor-master-plan.md
|   |   |--- GUIA_IMPLEMENTACAO_JWT_REDIS.md
|   |   |--- PLANO_REVOGACAO_JWT_REDIS.md
|   |   |--- PR_SUMMARY_JWT_REVOGACAO.md
|   |   |--- README.md
|   |   +--- README_JWT_REVOGACAO.md
|   |--- fixes
|   |   |--- CORRECOES_APLICADAS.md
|   |   |--- INICIO_RAPIDO_CORRECOES.md
|   |   |--- RESUMO_VISUAL_CORRECOES.txt
|   |   +--- status_correcoes.txt
|   |--- fixes-doc
|   |   |--- CHEATSHEET_JWT_REVOGACAO.md
|   |   |--- FIX_APLICADO.md
|   |   |--- FIX_BANNERS_NAO_RENDERIZAM.md
|   |   |--- FIX_DEFINITIVO_SERVIDOR.md
|   |   |--- FIX_DEPLOY_ERROR.md
|   |   |--- FIX_DIGEST_ERROR.md
|   |   |--- FIX_DIGEST_ERROR_NEXTJS.md
|   |   |--- FIX_DIGEST_ERROR_SOLUTION.md
|   |   |--- FIX_ERROR_HANDLERS.md
|   |   |--- FIX_ERROR_MESSAGE_NULL.md
|   |   |--- FIX_FINANCING_500_ERROR.md
|   |   |--- FIX_FINANCING_QUICK.md
|   |   |--- FIX_IMAGENS_404.md
|   |   |--- FIX_IMAGE_NAME_MISMATCH.md
|   |   |--- FIX_LEADS_WIZARD_500.md
|   |   |--- FIX_NAMESPACE_AGORA.txt
|   |   |--- FIX_RAPIDO.md
|   |   |--- FIX_REDIS_AGORA.bat
|   |   |--- FIX_REDIS_UPLOAD.md
...
|   |   +--- OAUTH_SUMMARY_VISUAL.txt
|   |--- task-4
|   |   |--- PLANO_2FA_ADMIN.md
|   |   |--- PR_SUMMARY_2FA.md
|   |   |--- QUICKSTART_2FA.md
|   |   |--- START_HERE_2FA.md
|   |   +--- VIEWS_TEMPLATES_2FA.md
|   |--- 01-architecture.md
|   |--- 02-domains-and-models.md
|   |--- 03-api-contracts.md
|   |--- 04-frontend-structure.md
|   |--- 05-hooks-and-data-layer.md
|   |--- 06-dashboard-and-analytics.md
|   |--- 14-migrations-and-schema-notes.md
|   |--- AUTH_ERROR_FIX_SUMMARY.md
|   |--- CODE_EXAMPLES_FEATURED_BANNER.md
|   |--- COMPONENT_BUTTON.md
|   |--- COMPONENT_CARD.md
...
|   |--- emails.md
|   |--- EXECUTIVE_SUMMARY.md
|   |--- frontend-web-dev.json
|   |--- IMPLEMENTACAO_CONFIRMACAO_SEGURA.md
|   |--- investigate.md
|   |--- README.md
|   |--- README_FRONTEND_AGENT.md
|   |--- RESUMO_CONFIRMACAO_SEGURA.md
|   |--- START_HERE.md
|   |--- SUMARIO_EXECUTIVO_JWT.md
|   +--- SUMMARY_FRONTEND_DOCS.md
|--- script
|   |--- rubocop_backup
|   |   +--- 20250927_032334
|   |       +--- fix_rubocop.rb
...
|   |--- fix-registry-names.sh
|   |--- fix_lint.sh
|   |--- fix_rubocop.rb
|   |--- lint_fixes_report_20250927_034123.txt
|   +--- test-workflow.sh
|--- scripts
|   |--- backup
|   |--- setup
|   |   |--- aplicar-correcoes.bat
|   |   |--- configurar-storage.bat
|   |   +--- install-oauth-gems.bat
|   |--- testing
|   |   |--- test-oauth-complete.bat
|   |   |--- test-oauth-quick.bat
|   |   +--- testar-correcoes.bat
|   |--- validation
|   |   +--- validate-oauth-implementation.bat
