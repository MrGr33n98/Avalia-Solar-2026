  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 font-sans">
      ...
      <div className="bg-white rounded-lg border border-slate-200 p-4 shadow-2xs">
        ...
        <div className="text-[11px] text-slate-500 mt-1">{totalDelivered.toLocaleString('pt-BR')} entregues</div>
      </div>
      ...
      <div className="bg-white rounded-lg border border-slate-200 p-4 shadow-2xs">
        ...
        <div className="text-[11px] text-slate-500 mt-1">{totalOpened.toLocaleString('pt-BR')} aberturas</div>
      </div>
      ...
      <div className="bg-white rounded-lg border border-slate-200 p-4 shadow-2xs">
        ...
        <div className="text-[11px] text-slate-500 mt-1">{totalClicked.toLocaleString('pt-BR')} cliques em links</div>
      </div>
      ...
      <div className="bg-white rounded-lg border border-slate-200 p-4 shadow-2xs">
        ...
        <div className="text-[11px] text-slate-500 mt-1">Contratos ganhos Pós-Campanha</div>
      </div>
    </div>
  );
}
