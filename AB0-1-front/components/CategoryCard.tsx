...
export default function CategoryCard({ category, className = "" }: CategoryCardProps) {
  ...
  const displayData = {
    ...
    rating: (category as any)?.average_rating || 4.8,
  };
        ...
        >
          ...
          <div className="relative h-48 overflow-hidden bg-muted">
             ...
             <div className="absolute top-3 left-3">
               <Badge variant="secondary" className="bg-white/90 text-primary hover:bg-white shadow-sm backdrop-blur-sm">
          ...
          <CardContent className="px-5 pb-4 pt-2 flex-grow">
