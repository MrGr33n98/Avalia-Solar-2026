...
export function AnalyticsDebugger() {
  ...
  useEffect(() => {
    ...
    const isInternal = typeof window !== 'undefined' && localStorage.getItem('is_internal_team') === 'true';
      ...
      {isOpen && (
        <div className="mb-2 max-h-[400px] w-[350px] overflow-y-auto rounded-lg border border-gray-200 bg-white p-4 shadow-2xl">
          ...
          <div className="space-y-3">
            ...
            {events.map((event) => (
              <div key={event.id} className="rounded border border-gray-100 bg-gray-50 p-2 text-[10px]">
