...
export default function CategoryCompaniesTable({ companies }: CategoryCompaniesTableProps) {
  ...
  return (
    ...
    <section id="more-companies-section" className="space-y-6 pt-4">
      ...
      <div className="hidden min-w-0 overflow-hidden rounded-[24px] border border-slate-200/80 bg-white shadow-[0_8px_30px_rgba(15,23,42,0.035)] lg:block">
        ...
        <table className="w-full table-fixed border-collapse text-left text-sm text-slate-600">
          ...
          <thead className="border-b border-slate-200/80 bg-slate-50/80 text-[10.5px] font-bold uppercase tracking-[0.08em] text-slate-500">
            ...
            <tr>
              ...
              <th scope="col" className="w-10 px-3 py-4 text-center">
          ...
          <tbody className="divide-y divide-slate-100 font-medium">
            ...
            {paginatedCompanies.map((company, index) => {
              ...
              return (
                ...
                <tr key={company.id} className="group/row transition-colors duration-200 hover:bg-blue-50/25">
...
function CategoryCompanyCard({ company, position }: { company: Company; position: number }) {
  ...
  return (
    ...
    <article className="min-w-0 rounded-[20px] border border-slate-200/80 bg-white p-4 shadow-[0_6px_24px_rgba(15,23,42,0.04)] transition-shadow hover:shadow-[0_10px_30px_rgba(15,23,42,0.07)]">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="flex items-start justify-between gap-2">
            ...
            <div className="min-w-0 flex-1">
              ...
              <Link href={href} className="block truncate text-sm font-bold tracking-[-0.01em] text-slate-950 hover:text-blue-700">
    ...
    >
      ...
      {!mobile && (
        ...
        <ComparisonToggleButton
          ...
          className="h-10 w-10 min-h-10 min-w-10 shrink-0 rounded-full border border-slate-200 bg-white p-0 text-blue-600 shadow-[0_2px_8px_rgba(15,23,42,0.06)] transition-all duration-200 hover:border-blue-200 hover:bg-blue-50 hover:text-blue-700 hover:shadow-[0_4px_12px_rgba(37,99,235,0.12)]"
      ...
      {canRequestQuote && (
        ...
        <QuoteCTA
          ...
          className={cn(
            ...
            'h-10 whitespace-nowrap rounded-xl px-4 shadow-[0_4px_12px_rgba(37,99,235,0.14)]',
