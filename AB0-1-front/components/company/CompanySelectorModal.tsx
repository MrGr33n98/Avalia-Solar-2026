...
import { Check, ChevronsUpDown, Plus, Search, MapPin, Building2, ExternalLink, Loader2 } from 'lucide-react';
                ...
                <div className="space-y-3">
                  {isLoading ? (
                    ...
                    filteredCompanies.map((company) => (
                      <div
                        key={company.id}
                        className="flex items-center gap-4 p-4 rounded-xl border border-gray-100 hover:border-primary/30 hover:bg-primary/5 transition-all group cursor-pointer"
