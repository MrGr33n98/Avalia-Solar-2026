  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-10 text-center">
        <LineChart className="mx-auto h-9 w-9 text-violet-600" />
        ...
        <Link href="/creator-studio/tree" className="mt-4 inline-flex rounded-lg border border-violet-200 px-4 py-2 text-sm font-semibold text-violet-700">Ver métricas do Tree</Link>
      </div>
    </div>
  );
}
