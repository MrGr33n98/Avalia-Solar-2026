  ...
  return (
    <Card className="relative overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
      <div className="flex flex-col">
        ...
        <div className="flex items-center justify-between gap-4 border-b border-slate-200 px-5 py-5 sm:px-6">
          ...
          {ratingCount > 0 && (
            <Button
              ...
              className="inline-flex min-h-11 items-center gap-1 rounded-lg px-3 text-xs font-bold text-blue-700 hover:bg-slate-50 hover:text-blue-900 focus-visible:ring-2 focus-visible:ring-blue-600"
            >
              Ver todas
        ...
        {ratingCount > 0 && (
          <div className="m-5 flex flex-col gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 sm:m-6 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center gap-3">
              <div className="flex h-16 w-16 shrink-0 flex-col items-center justify-center rounded-lg border border-slate-200 bg-white p-3">
        ...
        {reviewsLoading ? (
          ...
          <div className="grid grid-cols-1 border-t border-slate-200 md:grid-cols-2">
            {recentReviews.map((review) => {
              ...
              return (
                <div
                  key={review.id}
                  className="flex flex-col justify-between border-b border-slate-200 bg-white p-5 last:border-b-0 md:border-b-0 md:border-r md:last:border-r-0 sm:p-6"
                >
                  <div>
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div
                        className="flex items-center gap-1 rounded-lg border border-amber-200 bg-amber-50 px-2 py-1 text-amber-800"
          ...
          <div className="m-5 rounded-xl border border-slate-200 bg-slate-50 p-8 text-center sm:m-6">
            ...
            <Button
              size="sm"
              onClick={() => onTabChange('reviews')}
              className="inline-flex min-h-11 items-center gap-1.5 rounded-lg bg-[#0B1F4B] text-xs font-bold text-white shadow-none hover:bg-[#102b66] focus-visible:ring-2 focus-visible:ring-[#0B1F4B] focus-visible:ring-offset-2"
            >
              Fazer uma avaliação
              <ArrowRight className="h-3.5 w-3.5" aria-hidden="true" />
            </Button>
