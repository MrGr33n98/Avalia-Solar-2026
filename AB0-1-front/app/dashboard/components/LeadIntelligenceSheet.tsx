...
export default function LeadIntelligenceSheet({ isOpen, onClose, lead }: LeadIntelligenceSheetProps) {
  ...
  return (
    <Sheet open={isOpen} onOpenChange={onClose}>
      <SheetContent className="sm:max-w-xl w-full p-0 overflow-y-auto bg-slate-50 dark:bg-[#0B1120] border-l border-slate-200 dark:border-white/5 no-scrollbar">
        {/* Header - Glassmorphism */}
        <div className="sticky top-0 z-10 w-full p-8 bg-white/60 dark:bg-[#0B1120]/60 backdrop-blur-xl border-b border-white/20 dark:border-white/5">
          <SheetHeader className="text-left">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <SheetTitle className="text-2xl font-black uppercase tracking-tighter text-foreground dark:text-white">
        ...
        <div className="p-8 space-y-10">
          ...
          <motion.div 
            ...
            className="p-6 rounded-[2rem] bg-brand-blue text-white shadow-2xl shadow-brand-blue/30 relative overflow-hidden clay-convex border border-white/10"
          >
          ...
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-5 rounded-3xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-white/5 transition-all hover:border-brand-blue/20 clay-precision shadow-sm">
                <p className="text-[9px] font-black uppercase tracking-widest text-muted-foreground/50 mb-2">Consumo Mensal</p>
              ...
              <div className="p-5 rounded-3xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-white/5 transition-all hover:border-brand-blue/20 clay-precision shadow-sm">
                <p className="text-[9px] font-black uppercase tracking-widest text-muted-foreground/50 mb-2">Fatura Média</p>
                <p className="text-lg font-black text-foreground dark:text-white">
                  {formatCurrency(lead.technical_profile?.bill_value)}
                </p>
              </div>
              <div className="p-5 rounded-3xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-white/5 transition-all hover:border-brand-blue/20 clay-precision shadow-sm">
                <p className="text-[9px] font-black uppercase tracking-widest text-muted-foreground/50 mb-2">Porte Sugerido</p>
                <div className="flex items-center gap-2">
              ...
              <div className="p-5 rounded-3xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-white/5 transition-all hover:border-brand-blue/20 clay-precision shadow-sm">
                <p className="text-[9px] font-black uppercase tracking-widest text-muted-foreground/50 mb-2">Janela de Decisão</p>
                <div className="flex items-center gap-2">
            ...
            <div className="p-5 rounded-3xl bg-slate-100 dark:bg-slate-900/50 border-none clay-concave">
              <div className="flex items-start gap-4">
                <div className="p-2 rounded-xl bg-green-500/10 text-green-500 shadow-inner">
                  <ShieldCheck className="h-5 w-5" />
                </div>
                <div>
                  <p className="text-[9px] font-black uppercase tracking-widest text-muted-foreground/50 mb-1">Qualificação Financeira</p>
                  <p className="text-sm font-bold text-foreground dark:text-white">
          ...
          <section className="space-y-6">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-sm font-black uppercase tracking-widest text-foreground dark:text-white">Sinais de Engajamento Recente</h3>
            </div>
            
            <div className="p-6 rounded-[2rem] bg-brand-blue/5 border border-brand-blue/10 clay-concave">
          ...
          <section className="space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-white/5 clay-precision shadow-sm">
                <div className="flex items-center gap-3">
                  <LinkIcon className="h-4 w-4 text-muted-foreground/30" />
                  <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/60">Canal de Aquisição</span>
                </div>
              ...
              {lead.marketing_data?.utm_campaign && (
                <div className="flex items-center justify-between p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-white/5 clay-precision shadow-sm">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/60">Campanha Marketing</span>
                  </div>
              ...
              <div className="flex items-center justify-between p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-white/5 clay-precision shadow-sm">
                <div className="flex items-center gap-3">
                  <MousePointer2 className="h-4 w-4 text-muted-foreground/30" />
                  <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/60">Caminho de Conversão</span>
                </div>
                <span className="text-[10px] font-mono text-muted-foreground truncate max-w-[200px]">{lead.marketing_data?.landing_path || '/home'}</span>
              </div>
            </div>
          </section>
          ...
          <div className="pt-6 border-t border-slate-200 dark:border-white/5">
            <Button className="w-full h-14 rounded-2xl bg-brand-blue hover:bg-blue-700 text-white font-black uppercase tracking-widest text-xs shadow-xl shadow-brand-blue/20 clay-convex transition-transform active:scale-95">
              Exportar Dossier PDF Inteligente
