...
import { Loader2, Eye, EyeOff, AlertCircle } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Use router.push for client-side navigation if possible, but window.location ensures full reload if state needs fresh start
      // The original code used window.location.href, sticking to that for consistency with AuthContext state update reliability
