...
import { Loader2, AlertCircle, Building, Upload, X } from 'lucide-react';
...
export default function CompanyRegisterForm({ onSuccess }: CompanyRegisterFormProps) {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      formData.append('company[terms_accepted]', data.termsAccepted.toString());
      formData.append('company[newsletter_opt_in]', data.newsletter.toString());
